function [R_2_all] = bayes_cpt_r2(data,k_max,d_min,k_0,v_0,sig_0,num_samp)
% Test R^2 as a function of k
%
% INPUT
...
figure; plot(R_2_all(:,1),R_2_all(:,2),'r-o')