function [AnDarksamtest1] = AnDarksamtest(X,alpha)
...
AnDarksamtest1.k = k;
AnDarksamtest1.nties = N-L;
AnDarksamtest1.meanADRstat = k-1;
AnDarksamtest1.stdADRstat = sqrt(vADK);
AnDarksamtest1.ADKn = ADKn;
AnDarksamtest1.ADKsn = ADKsn;
AnDarksamtest1.Pn = Pn;
AnDarksamtest1.ADK = ADK;
AnDarksamtest1.ADKs = ADKs;
AnDarksamtest1.P = P;
