function [s,x_grid,y_grid] = evoperiodogram(data,window,step,fmin,fmax,normal)
% INPUT
...
for i =1:npts_new
    d = z(i,:);
    [pxx,~] = periodogram(d,[],pad*n_win,1/dt);
    s(i,:) = pxx';
end
% debug
for i = npts_new
    d = z(i,:);
    [~,f] = periodogram(d,[],pad*n_win,1/dt);
end
