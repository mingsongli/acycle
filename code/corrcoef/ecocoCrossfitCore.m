...
reportProgress(progressFcn,fraction,sprintf( ...
    ['Cross-fitted eCOCO overall window work: %d of %d equivalents; ', ...
     'current window %d of %d; Monte Carlo batch %d-%d of %d'], ...
    windowEquivalent,windowCount,windowIndex,windowCount, ...
    firstSimulation,lastSimulation,nsim));
lastPercent = percent;
end
