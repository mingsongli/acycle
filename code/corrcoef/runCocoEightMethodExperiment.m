...
if strcmp(task.family,'cv')
    ...
    figureKinds = { ...
        'held-out spectra','rate curves','pCOCO','Monte Carlo audit'};
    captionDetails = { ...
        ...
        ['same-rate consensus correlation weighted by its joint ', ...
         'full-pipeline global p-value'], ...
...
if strcmp(analysis.family,'cv')
    ...
    header = {'sedimentation_rate_cm_per_kyr','train_A','train_B', ...
        'validate_A_to_B','validate_B_to_A','consensus_rho', ...
        'global_p_A_to_B','global_p_B_to_A','consensus_global_p', ...
        'local_p_A_to_B','local_p_B_to_A','consensus_local_p','pCOCO'};
