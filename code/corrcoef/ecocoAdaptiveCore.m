...
%ECOCOADAPTIVECORE Batched full-grid Adaptive eCOCO analysis.
%
...
% COCoadaptiveEvaluate repeats four-group area/leakage fitting for
...
result = struct;
result.method = 'Adaptive eCOCO';
result.name = 'Adaptive eCOCO';
result.targetMode = 'Adaptive eCOCO';
...
if strcmp(windowMode,'physical-depth')
    result.algorithmVersion = ...
        'Adaptive eCOCO — physical-window full-grid v3';
    selectionRule = [ ...
    ...
    result.algorithmVersion = 'Adaptive eCOCO — full-grid local-p v2';
...
try
    ...
    warning('Acycle:AdaptiveECOCO:ProgressCallbackFailed', ...
